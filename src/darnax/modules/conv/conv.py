...
class Conv2D(Adapter):
    ...
    strength : float
        Variance of weights at initialization.
    key : KeyArray
    ...
    def __init__(
        ...
        *,
        ...
        self.kernel = (
            ...
            / jnp.sqrt(jnp.asarray(kh * kw * self.in_channels, dtype=dtype))
        )
    ...
    def __call__(self, x: Array, rng: KeyArray | None = None) -> Array:
        ...
        """
        return conv_forward(x, self.kernel, self.stride, self.padding_mode)
    ...
    def backward(self, x: Array, y: Array, y_hat: Array, gate: Array | None = None) -> Self:
        ...
        """
        grad = conv_backward_with_threshold(
            x=x,
            y=y,
            y_hat=y_hat,
...
class Conv2DRecurrentDiscrete(Layer):
    ...
    def backward(self, x: Array, y: Array, y_hat: Array, gate: Array | None = None) -> Self:
        ...
        Update Computation:
            ...
            2. Add weight decay term
            3. Apply update_mask to zero out constrained parameters
